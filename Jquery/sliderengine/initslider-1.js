jQuery(document).ready(function(){
    ...
    jQuery("#amazingslider-1").amazingslider({
        ...
        arrowwidth:32,
        texteffecteasing:"easeInOutExpo",
        texteffect:"fade",
        ...
        titlecss:"display:table; position:relative; font:18px \"Lucida Sans Unicode\",\"Lucida Grande\",sans-serif,Bell MT; color:#fff; white-space:nowrap; background-color:#000; padding:10px;",
        ribbonimagey:0,
        ribbonimagex:0,
        ...
        transition:"crossfade,elastic,blinds,blocks",
        scalemode:"fit",
        isfullscreen:false,
        textformat: {
